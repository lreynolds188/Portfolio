      ...
      <main className={styles.main}>
        <div>
          <div>
            ...
            <p className={styles.contactDeets}><a callName={styles.links} href="mailto:luke@thereynolds.com.au target="_blank">LUKE<\a> [AT] <a className={styles.links} href="https://thereynolds.com.au" target="_blank">THEREYNOLDS [DOT] COM [DOT] AU</a></p>
          </div>
