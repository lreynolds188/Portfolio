    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <div>
          ...
          <p className={styles.categoryDescription-main}>
          ...
          <p className={styles.categoryDetails}>In this position I worked in a computer store and distribution warehouse managing the redistribution of ex-government hardware. My position included such jobs as system reloads, stripping hardware, technical support, computer & phone repairs, and on-site support.</p>
          <br />
