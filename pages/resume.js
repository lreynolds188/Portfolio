    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <div>
          ...
          <a className={styles.contactDeets} href="luke@thereynolds.com.au" target="_blank">E: luke@thereynolds.com.au</a>
          <p className={styles.contactDeets}>&nbsp;|&nbsp;</p>
          <a className={styles.contactDeets} href="thereynolds.com.au" target="_blank">W: thereynolds.com.au</a>
