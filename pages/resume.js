    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <div>
          ...
          <br />
          <p className={styles.contactDeets}>QUEENSLAND, AU | M: 0420 619 829 | E:&nbsp;</p>
          ...
          <a className={styles.contactDeets} href="thereynolds.com.au" target="_blank">THEREYNOLDS.COM.AU</a>
