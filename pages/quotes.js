        ...
        <div>
          ...
          <div className={styles.content}>
            ...
            <ul className={styles.descriptionLeft}>
              ...
              <li>
                Falling is not a failure, failure comes when you stay where you
                have fallen.
              </li>
          ...
          <div className={styles.content}>
            ...
            <ul className={styles.descriptionLeft}>
              <li>
                ...
                those willing to endure pain with patience.
              </li>
          ...
          <div className={styles.content}>
            <h3 className={styles.noTopMargin}>
              William Shakespeare (Playwright/Actor, 1564 - 1616)
            </h3>
            <ul className={styles.descriptionLeft}>
          ...
          <div className={styles.content}>
            <h3 className={styles.noTopMargin}>
              John Locke (Philosopher/Physician, 1632 - 1704)
            </h3>
            <ul className={styles.descriptionLeft}>
              <li>
              ...
              <li>
                The actions of people are the best way to interprete their
                thoughts.
              </li>
            </ul>
            <br />
          ...
          <div className={styles.content}>
            <h3 className={styles.noTopMargin}>
              Sir Isaac Newton (Physicist/Mathematician, 1642 - 1727)
            </h3>
            <ul className={styles.descriptionLeft}>
              <li>
              ...
              <li>
                ...
                understand things that are true, for if the things are false,
                the apprehension of them is not understanding.
              </li>
              <li>
                If I am anything, which I highly doubt, I have made myself so by
                hard work.
              </li>
            </ul>
            <br />
          ...
          <div className={styles.content}>
            ...
            <ul className={styles.descriptionLeft}>
              <li>
                I undertook something that not everyone may undertake: I
                descended into the depths, I bored into the foundations.
              </li>
              <li>
              ...
              <li>
                I am a forest, and a night of dark trees: but those who are not
          ...
          <div className={styles.content}>
            ...
            <ul className={styles.descriptionLeft}>
              ...
              <li>
                ...
                succeed is to always try just one more time.
              </li>
            </ul>
            <br />
          </div>
          ...
          <div className={styles.content}>
            <h3 className={styles.noTopMargin}>
              Alexander Graham Bell (Inventor/Scientist, 1847 - 1922)
            </h3>
            <ul className={styles.descriptionLeft}>
              <li>
                When one door closes, another one opens. However we often look
                so long and so regretfully on the closed door, that we do not
          ...
          <div className={styles.content}>
            <h3 className={styles.noTopMargin}>
              Sigmund Freud (Neurologist/Psychoanalyst, 1856 - 1939)
            </h3>
            <ul className={styles.descriptionLeft}>
              <li>
          ...
          <div className={styles.content}>
            <h3 className={styles.noTopMargin}>
              Nicola Tesla (Physicist/Electrical Engineer, 1856 - 1943)
            </h3>
            <ul className={styles.descriptionLeft}>
              <li>
                The scientists of today think deeply instead of clearly. One
                must be sane to think clearly, but one can think deeply and be
                quite insane.
              </li>
              <li>
          ...
          <div className={styles.content}>
            <h3 className={styles.noTopMargin}>
              Bernard Shaw (Playwright/Activist, 1856 - 1850)
            </h3>
            <ul className={styles.descriptionLeft}>
              <li>
          ...
          <div className={styles.content}>
            <h3 className={styles.noTopMargin}>
              Mahatma Gandhi (Activist/Lawyer, 1869 - 1948)
            </h3>
            <ul className={styles.descriptionLeft}>
          ...
          <div className={styles.content}>
            <h3 className={styles.noTopMargin}>
              Sir Winston Churchill (Prime Minister/Politician, 1874 - 1965)
            </h3>
            <ul className={styles.descriptionLeft}>
              ...
              <li>
                The best argument against democracy is a 5 minute conversation
                with the average voter.
              </li>
              <li>
                The truth is incontrovertible. Panic may resent it, ignorance
          ...
          <div className={styles.content}>
            <h3 className={styles.noTopMargin}>
              Franklin D. Roosevelt (President/Politician, 1882 - 1945)
            </h3>
            <ul className={styles.descriptionLeft}>
              ...
              <li>
                The liberty of a democracy is not safe if the people tolerated
              ...
              <li>
                ...
                religions-bound together by a single unity, the unity of freedom
                and equality. Whoever seeks to set one nationality against
          ...
          <div className={styles.content}>
            <h3 className={styles.noTopMargin}>
              Eric Arthur Blair aka George Orwell (Author/Journalist, 1903 -
              1950)
            </h3>
            <ul className={styles.descriptionLeft}>
              <li>
              ...
              <li>
                I have seen British imperialism at work in Burma, and I have
                seen something of the effects of poverty and unemployment in
                Britian... One has got to be actively a socialist, not merely
                sympathetic to socialism, or one plays into the hands of our
                always active enemies.
              </li>
            </ul>
            <br />
          </div>
          ...
          <div className={styles.content}>
            <h3 className={styles.noTopMargin}>
              Malcolm X (Minister/Activist, 1925 - 1965)
            </h3>
            <ul className={styles.descriptionLeft}>
              <li>
                If you're not careful the papers will have you hating the people
                who are getting oppressed and loving the people who are doing
                the oppressing.
              </li>
            </ul>
            <br />
          ...
          <div className={styles.content}>
            <h3 className={styles.noTopMargin}>
              Patrick Stewart (Actor, 1940 - Present)
            </h3>
            <ul className={styles.descriptionLeft}>
              <li>
                If you pull at the loose threads of your self, you will unwind
          ...
          <div className={styles.content}>
            ...
            <ul className={styles.descriptionLeft}>
              <li>
                I have noticed that even those who assert that everything is
                predestined and that we can change nothing about it still look
          ...
          <div className={styles.content}>
            <h3 className={styles.noTopMargin}>
              Bob Marley (Singer/Songwriter, 1945 - 1981)
            </h3>
            <ul className={styles.descriptionLeft}>
              <li>
                If she's amazing, she won't be easy. If she's easy, she won't be
                amazing. If she's worth it, you wont give up. If you give up,
                you're not worthy.
              </li>
              <li>Love the life you live. live the life you love.</li>
              <li>None but ourselves can free our minds.</li>
              <li>
                The truth is, everyone is going to hurt you. You've just got to
              ...
              <li>
                Don't worry about a thing, 'cause every little thing's gonna be
                all right.
              </li>
            </ul>
            <br />
          ...
          <div className={styles.content}>
            ...
            <ul className={styles.descriptionLeft}>
              <li>
                ...
                It's not. The worst thing in life is ending up with people that
                make you feel alone.
              </li>
              <li>
          ...
          <div className={styles.content}>
            <h3 className={styles.noTopMargin}>
              Bill Gates (Entrepreneur/Software Developer, 1955 - Present){" "}
            </h3>
            <ul className={styles.descriptionLeft}>
              <li>
          ...
          <div className={styles.content}>
            <h3 className={styles.noTopMargin}>
              Keanu Reeves (Actor, 1964 - Present)
            </h3>
            <ul className={styles.descriptionLeft}>
              <li>
                If you have been brutally broken but still have the courage to
                be gentle to other living beings, then you're a badass with the
                heart of an angel.
              </li>
            </ul>
            <br />
          ...
          <div className={styles.content}>
            <h3 className={styles.noTopMargin}>
              Elon Musk (Entrepreneur, 1971 - Present)
            </h3>
            <ul className={styles.descriptionLeft}>
          ...
          <div className={styles.content}>
            ...
            <ul>
              ...
              <li>
                ...
                something else is the greatest accomplishment. - Ralph Emerson
              </li>
              <li>
              ...
              <li>
                ...
                cannot forget falls drop by drop upon the heart. - Aeschylus
              </li>
              <li>Do, or do not. There is no try. - Yoda</li>
              <li>
                You're not here to make the choice; you've already made it.
                You're here to understand why you make that choice. - The Matrix
              </li>
              <li>
                It may be the warriors who get the glory but it's the engineer's
                who build societies. - Snow Piercer
              </li>
              <li>
              ...
              <li>
                ...
                but when someone is unkind to me, weak is not what you are going
                to remember about me. - Al Capone
              </li>
              <li>
                The central problem - how to prevent power from being abused -
                remains unsolved. Dickens, who had not the vision to see that
                private property is an obstructive nuisance, had the vision to
                see that: 'If men would behave decently the world would be
                decent' is not such a platitude as it sounds. - George Orwell
              </li>
              <li>
                You wouldn't worry so much about what others think of you if you
                realised how seldom they do. - Eleanor Roosevelt
              </li>
              <li>Beware the fury of a patient man. - John Dryden</li>
              <li>Chess is won, one step at a time</li>
              <li>
                Every path is the right path. Everything could have been
              ...
              <li>
                The worst part about having a mental illness is people expect
                you to behave as if you don’t. - The Joker
              </li>
              <li>
                Their morals, their code; it's a bad joke. Dropped at the first
                sign of trouble. They're only as good as the world allows them
                to be. You'll see- I'll show you. When the chips are down these,
                uh, civilized people? They'll eat each other. See I'm not a
                monster, I'm just ahead of the curve.” - The Joker
              </li>
              <li>
                The young don't know enough to be prudent, and therefore they
              ...
              <li>
                When people are not punished for breaking the rules, the ones
                following the rules are the ones being punished -
                orderofmagnitude
              </li>
              <li>
              ...
              <li>
                ...
                stubbornly is because they sense that once hate is gone, they
                will be forced to deal with pain - James Baldwin
              </li>
              <li>
              ...
              <li>
                ...
                individual which excludes the love for others is not love, love
                for one's country which is not part of one's love for humanity
                is not love but idolatrous worship. - Eric Fromm
              </li>
              <li>To be wise is to suffer. - Sophocles</li>
              <li>
                When I was poor and complained about inequality they said I was
                bitter; now that I'm rich and I complain about inequality they
                say I'm a hypocrite. I'm beginning to think they just don't want
                to talk about inequality. - Russel Brand
              </li>
              <li>
                When I give food to the poor, they call me a saint. When I ask
                why the poor have no food, they call me a communist. - Dom
                Helder Camara
              </li>
              <li>
